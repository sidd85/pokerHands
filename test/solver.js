...
var Flush = require('../poker/solver').Flush;
var StraightFlush = require('../poker/solver').StraightFlush;
var Straight = require('../poker/solver').Straight;
var FourOfAKind = require('../poker/solver').FourOfAKind;
var FullHouse = require('../poker/solver').FullHouse;
var ThreeOfAKind = require('../poker/solver').ThreeOfAKind;
var TwoPair = require('../poker/solver').TwoPair;
var OnePair = require('../poker/solver').OnePair;
var HighCard = require('../poker/solver').HighCard;
var Game = require('../poker/solver').Game;
...
describe('High Card', function() {
  ...
  it('should be split according to House Way', function() {
    var hand = HighCard.solve(['5h', '6c', '7s', '9s', '2d', 'Kh', 'Tc']);
    return hand.descr.should.equal('K High');
  });
});
